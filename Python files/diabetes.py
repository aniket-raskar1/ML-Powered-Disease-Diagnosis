...
# Load dataset
data = pd.read_csv(r'C:\Users\Aniket\OneDrive\Desktop\AICTE Internship\MIcrosoft\Dataset\diabetes.csv')
...
for _ in range(10):  # Try multiple times to get best model
    ...
    if acc > 0.70 and prec > 0.60 and rec > 0.60:  # Lower the thresholds
        best_model = model
        best_accuracy = acc
        best_precision = prec
        best_recall = rec
...
if best_model:
    with open(r'C:\Users\Aniket\OneDrive\Desktop\AICTE Internship\MIcrosoft\Trained Models\diabetes_model.pkl', 'wb') as file:
